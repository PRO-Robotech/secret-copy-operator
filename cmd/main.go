...
import (
	...
	"secret-copy-operator/internal/controller"
...
func main() {
	...
	flag.DurationVar(&clientCacheTTL, "client-cache-ttl", 5*time.Minute,
		"TTL for cached cluster clients")
	...
	// Validate max-concurrent-reconciles early
	const maxAllowedConcurrentReconciles = 100
	if maxConcurrentReconciles < 1 || maxConcurrentReconciles > maxAllowedConcurrentReconciles {
		setupLog.Error(nil, "invalid max-concurrent-reconciles value",
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "215679ec.in-cloud.io",
	...
	if err = (&controller.SecretCopyReconciler{
		...
		setupLog.Error(err, "unable to create controller", "controller", "SecretCopy")
		os.Exit(1)
	}
